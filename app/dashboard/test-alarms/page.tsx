...
export default function TestAlarmsPage() {
  ...
  useEffect(() => {
    const update = () => {
      ...
      setAndroidIntentUrl(`intent:#Intent;action=android.intent.action.SET_ALARM;category=android.intent.category.BROWSABLE;S.android.intent.extra.alarm.MESSAGE=${msg};i.android.intent.extra.alarm.HOUR=${h};i.android.intent.extra.alarm.MINUTES=${m};B.android.intent.extra.alarm.SKIP_UI=false;component=com.google.android.deskclock/.HandleSetApiCalls;end`)
    }
    update()
