...
export default function AlarmsClient() {
  ...
  const getAndroidClockIntentUrl = (session: Session) => {
    ...
    return `intent:#Intent;action=android.intent.action.SET_ALARM;S.android.intent.extra.alarm.MESSAGE=${message};i.android.intent.extra.alarm.HOUR=${alarmH};i.android.intent.extra.alarm.MINUTES=${alarmM};B.android.intent.extra.alarm.SKIP_UI=false;component=com.google.android.deskclock/.HandleSetApiCalls;end`
  }
